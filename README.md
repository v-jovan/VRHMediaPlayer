...
I've made a simple media player (audio and video) in C# and WPF. The main task of this player is to provide basic interaction we are used to from the players.
